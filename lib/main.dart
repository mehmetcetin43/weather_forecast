...
class _MainWeatherScreenState extends State<MainWeatherScreen>
  ...
  Future<void> _fetchCurrentLocationWeather() async {
    ...
    if (weatherProvider.selectedLocation != null && weatherProvider.hasData && mounted) {
      Navigator.push(
        context,
        MaterialPageRoute(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 8),
                        Text(
                          weatherProvider.selectedLocation!.localizedName,
                        ...
                        Text(
                          '${weatherProvider.selectedLocation!.administrativeArea}, ${weatherProvider.selectedLocation!.country}',
                          style: Theme.of(context).textTheme.bodyMedium?.copyWith(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                onPressed: weatherProvider.isLoading ? null : _fetchCurrentLocationWeather,
                ...
                label: Text(weatherProvider.isLoading ? 'Konum Alınıyor...' : 'Mevcut Konum'),
